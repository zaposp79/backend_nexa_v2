...
CATALOG: dict[str, ErrorEntry] = {
    ...
    "SIM-00603": ErrorEntry("SIM-00603", "NOT_FOUND", "Simulación no encontrada", "El simulation_id solicitado no corresponde a ningún resultado guardado.", "Verifique el simulation_id. Use POST /simulation/calculate para generar una nueva simulación."),
    "SIM-00604": ErrorEntry("SIM-00604", "NOT_FOUND", "Simulación sin Visión Imprimible", "El resultado de la simulación no contiene datos de Visión Imprimible (calculado con una versión anterior del motor).", "Recalcule la simulación con POST /simulation/calculate para regenerar el resultado con la versión actual del motor."),
    # Dominio / Negocio
