...
def _period_cadena_a(v: Dict[str, Any]) -> Dict[str, Any]:
    return {
        ...
        "capacitacion_inicial": v.get("capacitacion_inicial_mensual") or None,
        "capacitacion_rotacion": v.get("capacitacion_rotacion_mensual") or None,
        "examenes_medicos": _or_none(v.get("examenes_medicos_mensual")),
        "estudios_seguridad": _or_none(v.get("estudios_seguridad_mensual")),
...
def _period_costos(v: Dict[str, Any]) -> Dict[str, Any]:
    return {
        ...
        "cadena_b": {
            ...
            "opex_fijo":           v.get("opex_fijo_cadena_b"),
            "inversiones":         v.get("capex_cadena_b"),
            "s_and_m":             v.get("sm_cadena_b"),
            "componente_variable": v.get("componente_variable_b"),
            "tarifa_canal":        v.get("tarifa_canal_cadena_b"),
            "opex_variable":       v.get("opex_variable_cadena_b"),
