...
Registers the `nexa_engine` alias (via `import backend_nexa`) and provides
...
# Ensure the directory containing `backend_nexa/` is on sys.path.
# parents[2] from backend_nexa/tests/conftest.py → project root's parent.
